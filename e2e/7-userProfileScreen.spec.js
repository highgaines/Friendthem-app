describe('User Profile Screen Flow', () => {
  ...
  // it('can edit user profile info', async () => {
  //   await element(by.id('login_button')).tap();
  //   await expect(element(by.text('LOG IN'))).toBeVisible();
  //   await element(by.id('email_input'));
  //   await element(by.id('email_input')).typeText('naz@simplefractal.com');
  ...
  //   await expect(element(by.id('age').withDescendant(by.id('edit-pencil'))));
  //   await element(by.id('age').withDescendant(by.id('edit-pencil'))).atIndex(0).tap();
  //   // await element(by.id('edit-pencil').withAncestor(by.id('age'))).atIndex(0).tap();
  //   // await element(by.id('input')).typeText('25');
  //   // await expect(element(by.id('input-display').withAncestor(by.id('age'))))
  // });
});
